    ...
    <div className="container mx-auto px-5">
      ...
      <ul className="grid grid-cols-3 gap-5 px-5 md:px-0 md:flex md:justify-between md:items-center">
        <>
          ...
          <li className={`mx-auto md:mx-0 xl:hidden w-40 relative left-5 md:relative-0 md:w-auto`}><img
            src={"./mblogo.svg"}
            alt={"mblogo.svg"}/></li>
        </>
        <>
          <li className={`mx-auto md:mx-0 hidden xl:block`}><img src={"./partners3.png"} alt={"partners3.svg"}/></li>
          <li className={`mx-auto md:mx-0 hidden xl:block`}><img src={"./Versace-Logo.png"} alt={"Versace-Logo.svg"}/>
          </li>
          ...
          <li className={`mx-auto md:mx-0 hidden xl:block w-40 relative left-5 md:relative-0 md:w-auto`}><img
            src={"./mblogo.png"}
            alt={"mblogo.svg"}/></li>
        </>
      </ul>
